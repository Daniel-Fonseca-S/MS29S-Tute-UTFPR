const TranslatorEs =
{
  ...
  getTwentyFortyDeclarationString: function (pintaSuit, declarationSuit) {
    if (pintaSuit === declarationSuit) { return 'Cuarenta de ' + TranslatorEs.getSuitName(declarationSuit); } else { return 'Veinte de ' + TranslatorEs.getSuitName(declarationSuit); }
  },
